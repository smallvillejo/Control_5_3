...
<?php if($Actualizacion_Datos=Auth::user()->Actualizacion_Datos=='Si'): ?>
...
<div class="panel panel-info">
	<div class="panel-heading">
		<h3 class="panel-title">Comercio ID:<?php echo e(Auth::user()->id_comercio); ?></h3>
	</div>
	<div class="panel-body">
		<div class="row">
			<?php if(Auth::user()->photo_perfil==null): ?>		
			<div class="col-md-3 col-lg-3 " align="center"> <img alt="User Pic" src="global/images/photo.jpg" class="img-circle img-responsive" title="Imagen de Perfil">
				<?php else: ?>				
				<?php if(File::exists(Auth::user()->photo_perfil)): ?>
				<div class="col-md-3 col-lg-3 " align="center"> <img alt="User Pic" src="<?php echo e(Auth::user()->photo_perfil); ?>" class="img-circle img-responsive" title="Imagen de Perfil">
					<?php else: ?>
					<div class="col-md-3 col-lg-3 " align="center"> <img alt="User Pic" src="global/images/photo.jpg" class="img-circle img-responsive" title="Imagen de Perfil">
						<?php endif; ?>
						<?php endif; ?>
						...
						<div class=" col-md-9 col-lg-9 "> 
							<table class="table table-user-information">
								...
								<tbody>
									...
									<tr>
										...
										<td><?php echo e(Auth::user()->apellido); ?></td>
									</tr>
									<tr>
										<td>Telefono Usuario:</td>
										<td><?php echo e(Auth::user()->telefono); ?></td>
									</tr>
									<tr>
										<td>Email:</td>
										<td><a href="mailto:<?php echo e(Auth::user()->correo); ?>"><?php echo e(Auth::user()->correo); ?></a></td>
									</tr>											

								</tbody>
							</table>
							<a href="#Formulario_editar_perfil" data-toggle = 'modal' id="<?php echo e(Auth::user()->id); ?>" class="firmar_sesion" data-backdrop="static" data-keyboard="false">
							...
							<a href="<?=URL::to('index');?>" data-toggle = 'modal' id="<?php echo e(Auth::user()->id); ?>" class="firmar_sesion" data-backdrop="static" data-keyboard="false">
								...
								<div class="modal-header">
									...
									<div class="modal-body">
										<div class="panel-body">	
											...
											<input type="hidden" id="id_user" name="id_user" class="form-control" value="<?php echo e(Auth::user()->id); ?>">			<div class="form-group">
											<font size ="3", color="#53a4ee" face="Arial Black"><?php echo e(Form::label("Nombre Usuario:")); ?></font>
											<font size ="3", color="#53a4ee" face="Arial Black"><input type="text" id="nombre_user" name="nombre_user" class="form-control" value="<?php echo e(Auth::user()->nombre); ?>"></font>
										</div>
										<div class="form-group">
											<font size ="3", color="#53a4ee" face="Arial Black"><?php echo e(Form::label("Apellido Usuario:")); ?></font>
											<font size ="3", color="#53a4ee" face="Arial Black"><input type="text" id="apellido_user" name="apellido_user" class="form-control" value="<?php echo e(Auth::user()->apellido); ?>">
											</font>
										</div>

										<div class="form-group">
											<font size ="3", color="#53a4ee" face="Arial Black"><?php echo e(Form::label("Email Usuario:")); ?></font>
											<font size ="3", color="#53a4ee" face="Arial Black"><input type="email" id="email_user" name="email_user" class="form-control" value="<?php echo e(Auth::user()->correo); ?>"></font>
										</div>	
										<div class="form-group">
											<font size ="3", color="#53a4ee" face="Arial Black"><?php echo e(Form::label("Telefono Usuario:")); ?></font>
											<font size ="3", color="#53a4ee" face="Arial Black"><input type="number" id="telefono_user" name="telefono_user" class="form-control" value="<?php echo e(Auth::user()->telefono); ?>"></font>
										</div>														
										<div class="form-group">
											<font size ="3", color="#53a4ee" face="Arial Black"><?php echo e(Form::label("Password User:")); ?></font>
										...
										<div class="form-group">
											<font size ="3", color="#53a4ee" face="Arial Black"><?php echo e(Form::label("Confirmar Password:")); ?></font>
										...
										<div class="form-group">								
											<font size ="3", color="#53a4ee" face="Arial Black"><?php echo e(Form::label("Aceptar los términos:")); ?></font>
