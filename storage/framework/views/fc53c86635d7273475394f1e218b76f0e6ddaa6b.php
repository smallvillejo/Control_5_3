...
<div class="panel panel-primary  col-xs-12 col-sm-12 col-md-6 col-md-offset-3">
	...
	<div class="panel-body"> 		
		...
		<div class="row">
			...
			<div class="form-group col-sm-8">
				<input type="text" name="DireccionEmpresa" id="DireccionEmpresa" class="form-control" placeholder="Ingresa el número telefónico de la empresa">
			</div>
		</div>
		<div class="row">
			<div class="form-group col-sm-4">
			...
			<div class="form-group col-sm-8">
				<input type="text" name="DireccionEmpresa" id="DireccionEmpresa" class="form-control" placeholder="Ingresa el email de la empresa">
			</div>
		</div>
		<div class="row">
			<div class="form-group col-sm-4">
			...
			<div class="form-group col-sm-8">
				<input type="text" name="DireccionEmpresa" id="DireccionEmpresa" class="form-control" placeholder="Ingresa logo de la empresa">
			</div>
		</div>
		<hr style="color: #0056b2;" />
		<div class="row">
			<div class="form-group col-sm-4">
				<i class="fa fa-wrench" aria-hidden="true"></i> Ruta Carpeta Descarga: <a href="#" data-toggle="popover" data-placement="top" title="Se recomienda seleccionar un lugar seguro como DROPBOX donde pueda almacenar datos de su empresa como imágenes de sus mercancías y copias de seguridad del sistema. ">?</a>
			</div>
			<div class="form-group col-sm-8">
				<input type="text" name="DireccionEmpresa" id="DireccionEmpresa" class="form-control" placeholder="Selecciona la carpeta descarga">								
			</div>
		</div>
		<div class="row">
