...
<script type="text/javascript">
	...
	var ImagenLogo="<?php echo e($logo_empresa); ?>;"
			...
			<div class="row">				
				...
				<form class="form-horizontal" enctype="multipart/form-data" id="FormularioRegistroCuenta" role="form" method="POST" action="" >
					...
					<div class="row">	
						...
						<div class="form-group col-sm-4">
							<input type="text" name="NombreEmpresa" id="NombreEmpresa" class="form-control" placeholder="Ingresa el nombre de la empresa" value="<?php echo e($NombreEmpresa); ?>" autofocus>
						</div>				
						...
						<div class="form-group col-sm-4">
							<input type="text" name="DireccionEmpresa" id="DireccionEmpresa" class="form-control" placeholder="Ingresa la dirección de la empresa" value="<?php echo e($direccion_empresa); ?>">
						</div>
					</div>
					<div class="row">
						<div class="form-group col-sm-2">
						...
						<div class="form-group col-sm-4">
							<input type="number" name="TelefonoEmpresa" id="TelefonoEmpresa" class="form-control" placeholder="Ingresa el número telefónico de la empresa" value="<?php echo e($telefono_empresa); ?>">
						</div>
						<div class="form-group col-sm-2">
							<i class="fa fa-envelope" aria-hidden="true"></i> Correo Empresa:
						</div>
						<div class="form-group col-sm-4">
							<input type="email" name="EmailEmpresa" id="EmailEmpresa" class="form-control" placeholder="Ingresa el email de la empresa" value="<?php echo e($correo_empresa); ?>">
						</div>
					</div>
					<div class="row">
						<div class="form-group col-sm-2">
