...
<div class="col-xs-12 col-sm-12 col col-md-6 col-lg-3">
	<div class="panel panel-info">
		<div class="panel-heading">
			<span class="badge btn-md btn-success" title="<?php echo e(strtoupper($nombre_alimento=$value->Alimento->nombre_alimento)); ?>">
			...
			<div class="panel-body">
				...
				<center><img class="cuadradoFoto FotoGrande" src="<?php echo e($value->Alimento->ruta_imagen_alimento); ?>" Imagen="<?php echo e($value->Alimento->ruta_imagen_alimento); ?>" width="80px" height="80px"/></center>	
				<?php else: ?>		
				<center><img class="cuadradoFoto" src="global/images/AlimentoNoDisponible.png" width="80px" height="80px"/></center>
				<?php endif; ?>
				<?php endif; ?>
					...
					<table class="table table-user-information">
						<div class="row">
								...
								<tr>
									...
									<td>								
										<span class="badge btn-md btn-success">
											<b><strong> <font size ="2"><?php echo e($value->cantidad_alimento_venta); ?></font></strong></b>
										</span>
									</td>
								</tr>
								<tr>
							...
							<tr>
								...
								<td>
									<span class="badge btn-md btn-success"><b><strong><font size ="2">
										$<?php echo e(number_format($value->total_alimento_venta)); ?> 
									</font></strong></b>
								</span>
							</td>
						</tr>						
