...
<input type="hidden" value="<?php echo e($nombre_alimento=$value->Alimento->nombre_alimento); ?>">
...
<div class="col-xs-12 col-sm-12 col col-md-6 col-lg-4">
	<div class="panel panel-info">
		...
		<div class="panel-body">
			...
			<center><img class="cuadradoFoto FotoGrande" src="<?php echo e($value->Alimento->ruta_imagen_alimento); ?>" Imagen="<?php echo e($value->Alimento->ruta_imagen_alimento); ?>" width="100px" height="100px"/></center>	
			<?php else: ?>		
			...
			<div class="panel panel-info">
							...
							<tr>
								...
								<td>								
									<span class="badge btn-md btn-success">
										<b><strong> <font size ="2"><?php echo e($value->cantidad_alimento_venta); ?></font></strong>
										</b></span>								
									</td>
								</tr>
								<tr>
									...
									<td>
										<span class="badge btn-md btn-success"><b><strong> <font size ="2">
											$ <?php echo e($value->precio_alimento_venta); ?> 
										</font></strong></b></span>
									</td>								
								</tr>
								<tr>
				...
				<div class="panel-footer"><strong>Hora Venta:</strong> <?php echo e(Carbon::parse($value->hora_venta_alimento)->diffForHumans()); ?>
