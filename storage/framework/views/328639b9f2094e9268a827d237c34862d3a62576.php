								...
								<tr>
									...
									<div class="form-group">				
										<div class="input-group date date-picker margin-bottom-5" data-date-format="yyyy-mm-dd">
											<input type="text" class="form-control form-filter input-sm" name="Fecha_Ingreso_Gasto" id="Fecha_Ingreso_Gasto"   placeholder="Fecha Registro" value="<?php echo e(Carbon::today()->toDateString()); ?>" readonly>
					...
					<div class="row">
						<tbody>
							...
							<tr>
								...
								<div class="form-group">				
									<div class="input-group date date-picker margin-bottom-5" data-date-format="yyyy-mm-dd">
										<input type="text" class="form-control form-filter input-sm" name="Fecha_Ingreso_Gasto_Editar" id="Fecha_Ingreso_Gasto_Editar"   placeholder="Fecha Registro" value="<?php echo e(Carbon::today()->toDateString()); ?>" readonly>
										<span class="input-group-btn">
											<button class="btn btn-sm default" type="button"><i class="fa fa-calendar"></i></button>
										</span>
									</div>
...
<script type="text/javascript">
	...
	$('.CerrarMensaje').click(function(){
		...
		$('#Fecha_Ingreso_Gasto').val('<?php echo e(Carbon::today()->toDateString()); ?>');	
	...
	function Cargar_Tabla_Gastos(){
		$.ajax({
			type:'get',
			url:'<?php echo e(url('Cargar_Tabla_Gastos')); ?>',
