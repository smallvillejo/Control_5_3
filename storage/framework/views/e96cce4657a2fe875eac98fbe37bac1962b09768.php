		...
		<li class="dropdown" id="reportes" class="reportes">
			...
			<a class="dropdown-toggle" data-toggle="dropdown" href="#">Reportes - Balance
				...
				<ul class="dropdown-menu">
					<li>							
						<a href="<?php echo e(URL::route('Exportar_Excel_Total_Productos')); ?>" title="Exportar Excel" id="btn_reporte_excel_producto"><i class="fa fa-file-excel-o" aria-hidden="true"></i>Exporta en EXCEL</a>	
					</li>
					<li>
