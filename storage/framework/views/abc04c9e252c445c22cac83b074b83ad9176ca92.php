								...
								<tr>
									...
									<div class="form-group">				
										<div class="input-group date date-picker margin-bottom-5" data-date-format="yyyy-mm-dd">
											<input type="text" class="form-control form-filter input-sm" name="Fecha_Ingreso_Compra" id="Fecha_Ingreso_Compra"   placeholder="Fecha Registro" value="<?php echo e(Carbon::today()->toDateString()); ?>" readonly>
...
<script type="text/javascript">
	...
	$('.CerrarMensaje').click(function(){
		...
		$('#Fecha_Ingreso_Compra').val('<?php echo e(Carbon::today()->toDateString()); ?>');	
		...
		if(!patron.test(Valor_Ingreso_Compra)){
			...
			if(Valor_Ingreso_Compra==""){
				...
				if(!patron2.test(Descripcion_Ingreso_Compra)){
					$('#estilo').show();
					document.getElementById("mensaje").innerText = "La descripción de la compra no puede estar vacio o espacios en blanco.";
					document.getElementById("mensaje").style.display = "block";
					$('#Descripcion_Ingreso_Compra').val('');      
