...
<body class="page-md login" onload="ini();deshabilitaRetroceso();">
  ...
  <div class="content">
    ...
    <form class="login-form" action="Login" method="post">
      ...
      <?php if(session()->has("messagee") or (session()->has("message"))): ?>
      <div class="alert alert-danger info2" id="success-alert2"> 
        <strong>
          <ul2><?php echo e(Session::get("messagee")); ?><?php echo e(Session::get("message")); ?></ul2>
        </strong>
      </div>
      <?php endif; ?>
      ...
      <div class="alert alert-danger info2" id="success-alert2"> 
        <strong>
          <ul2><?php echo e(Session::get("Session_Expired")); ?></ul2><i class="fa fa-clock-o fa-2x" aria-hidden="true" style="margin-left: 80px;"></i>
        </strong>
      </div>
      <?php endif; ?>
