			...
			<div class="panel panel-primary">
				...
				<div class="panel-body">
					...
					<div class="panel-footer">Panel de opciones
						<div class="pull-right">
							<a href="#" data-toggle = 'modal' data-target="#ModalEditar_Registro_Recargas"  class="Editar_Minutos_Registrados" id_venta_recarga="<?php echo e($value->id); ?>"  title="Editar">  
								<strong> <font size ="3", color ="#0d96ea" face="Lucida Sans">
									<span class= "fa fa-pencil-square fa-2x"></span></font>
								</strong>
							</a>
							<a href="#" class="Eliminar_Venta_Recarga" id_Categoria_Venta_Eliminar="<?php echo e($value->id_venta_recarga); ?>" Nombre_Categoria_Venta_Eliminar="<?php echo e($value->Recarga->nombre_categoria); ?>" title="Eliminar"> 
								<strong> <font size ="3", color ="#0d96ea" face="Lucida Sans">
