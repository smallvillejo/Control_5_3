								...
								<tr>
									...
									<div class="form-group">				
										<div class="input-group date date-picker margin-bottom-5" data-date-format="yyyy-mm-dd">
											<input type="text" class="form-control form-filter input-sm" name="Fecha_Ingreso_Venta_Internet" id="Fecha_Ingreso_Venta_Internet"   placeholder="Fecha Registro" value="<?php echo e(Carbon::today()->toDateString()); ?>" readonly>
...
<script type="text/javascript">
	...
	$('.CerrarMensaje').click(function(){
		...
		$('#Fecha_Ingreso_Venta_Internet').val('<?php echo e(Carbon::today()->toDateString()); ?>');	
