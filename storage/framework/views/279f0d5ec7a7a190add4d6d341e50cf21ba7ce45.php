			...
			<div class="panel-body">
				<table class="table table-user-information">
					...
					<div class="panel-footer">Panel de opciones
						<div class="pull-right">
							<a href="#" class="Editar_Compra" Id_Compra_Editar="<?php echo e($value->id_compra); ?>" Valor_Compra_Editar="<?php echo e($value->valor_total_compra); ?>" Fecha_Compra_Editar="<?php echo e($value->fecha_compra); ?>" title="Editar">  
