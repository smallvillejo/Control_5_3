	...
	<div class="modal-dialog">		
		<div class="modal-content">
			...
			<div class="modal-body">
				<b><strong> <font size ="3", color="#0b6ef6" face="Arial Black">Se va a eliminar la venta del producto:</font></strong></b><b><strong> <font size ="3", color="#000000" face="Arial Black"><label name="Producto_Venta" id="numero_venta_producto""></font></strong></b></label><input type="text" name="id_venta" id="id_venta">
				<input type="text" name="cantidad_alimento_vendido" id="cantidad_alimento_vendido">
				<input type="text" name="id_alimento_venta" id="id_alimento_venta">
			</div>
