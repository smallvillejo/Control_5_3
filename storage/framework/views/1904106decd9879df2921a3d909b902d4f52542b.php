...
<div class="col-md-10">
	<img src="global/images/Error_No_Found_Alimento.png" alt="logo" class="img-thumbnail img-responsive" >	
</div>
<?php else: ?>
...
<div class="row">
	...
	<div class="portlet box blue table-responsive">
		<div class="portlet-title">
			<div class="caption">
				<i class="fa fa-cogs"></i>Listado Ventas Alimentos
			</div>
			<div class="tools">
			...
			<table class="table table-bordered table-striped table-condensed flip-content">
				...
				<tbody>
					...
					<tr class="even pointer">
						<td class=" "><b><strong> <font size ="3", color="#000000" face="Arial Black"><?php echo e($value->Alimento->nombre_alimento); ?></font></strong></b></td>
						...
						<td class=" "><b><strong> <font size ="3", color="#fb0c48" face="Arial Black">$<?php echo e($ValorVenta); ?></font></strong></b></td>
