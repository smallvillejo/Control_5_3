        ...
        <table>
          ...
          <tbody class="body">
            ...
            <tr>
              ...
              <td class="desc"><b><strong><font size ="5", face="Arial Black"><?php echo e($value->nombre_producto); ?></font></strong></b></td>
              <td class="qty"><?php echo e($value->cantidad_producto); ?> </td>
              <td class="qty">$<?php echo e($Valor_Venta=number_format($value->valor_venta_producto)); ?></td>
              <td class="qty">$<?php echo e($Valor_Inversion_Total=number_format($value->valor_inversion_producto)); ?> </td>
