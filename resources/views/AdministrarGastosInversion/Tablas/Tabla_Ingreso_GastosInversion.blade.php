		...
		<div class="panel-heading" style="background-color: #34ba8f">
			<h3 class="panel-title">
				...
				<div class="pull-right">
					...
					<label><font size ="3", color color="#000000" face="Tahoma"><strong>${{number_format($Valor_Gasto)}}</strong></font></label>
				</div>
			</h3>
		</div>
			...
			<div class="panel panel-primary">
				<div class="panel-heading" style="background-color: #ff7214">		<h3 class="panel-title">
					<b>
						...
						<font size ="3", color color="#000000" face="Tahoma"><strong>#{{$value->id_gasto}}</strong></font>
					</b>
				</h3>
			</div>
			<div class="panel-body">
				<table class="table table-user-information">
								...
								<td>								
									<span class="badge btn-md btn-success" style="background: #dd5816;">
										<b>
											<strong>
												<font size ="2">
													$ {{number_format($value->valor_gasto)}}		
												</font>
											</strong>
										</b>
									</span>
								...
								<tr>
									...
									<td>
										<span class="badge btn-md btn-success" style="background-color: #0270f7">
											<b>
												<strong>
													<font size ="2">{{Carbon::parse($value->hora_gasto)->diffForHumans()}}
													</font>
												</strong>
											</b>
										</span>	
					...
					<div class="panel-footer">Panel de opciones
						<div class="pull-right">
							<a href="#" class="Editar_Gasto" Id_Gasto_Editar="{{$value->id_gasto}}" Valor_Gasto_Editar="{{$value->valor_gasto}}" Fecha_Gasto_Editar="{{$value->fecha_gasto}}" Descripcion_Gasto_Editar="{{$value->descripcion_gasto}}" title="Editar">  
								<strong> <font size ="3", color ="#0d96ea" face="Lucida Sans">
									<span class= "fa fa-pencil-square fa-2x"></span></font>
								</strong>
							</a>
							<a href="#" class="Eliminar_Gasto" Id_Gasto_Eliminar="{{$value->id_gasto}}"  title="Eliminar"> 
								<strong> <font size ="3", color ="#0d96ea" face="Lucida Sans">
