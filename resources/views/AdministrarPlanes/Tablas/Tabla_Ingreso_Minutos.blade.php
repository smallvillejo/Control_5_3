			...
			<div class="panel-body">
				...
				<div class="panel-footer">Panel de opciones
					<div class="pull-right">
						...
						<a href="#" data-toggle = 'modal' data-target="#Eliminar_Registro_VentaMinuto" id="{{$value->id_detalle_plan}}"  Cantidad_Minutos_Restantes_Plan="{{$value->PlanMinutos->cantidad_minutos_restantes}}" Cantidad_Minutos_Vendidos="{{$value->cantidad_minutos_vendidos}}" class="Eliminar_Venta_Minuto" data-backdrop="static" data-keyboard="false" title="Eliminar">  <strong> <font size ="3", color ="#0d96ea" face="Lucida Sans"><span class= "fa fa-trash-o fa-2x"></span></font></strong>
						</a>	
					</div>
				</div>
			</div>
