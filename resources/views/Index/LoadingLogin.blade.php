 		...
 		<div style="width: 500px; margin: 150 auto; ">
 			<div class="panel panel-success">
 				...
 				<div class="panel-body">
 					...
 					<label><h3>{{Auth::user()->nombre}} {{Auth::user()->apellido}}</h3></label><br> 				
 					<label><h5><b><strong> <font size ="2", color="#800000" face="Arial Black">{{$nombre_perfil}}</font></strong></b></h5></label>
 				</div>
...
// }
Tiempo_Inactividad2=setTimeout('document.location.href = "{{ route('Index')}}"',5000);
