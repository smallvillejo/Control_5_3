...
<input type="hidden" value="{{$nombre_alimento=$value->Alimento->nombre_alimento}}">
...
<div class="col-xs-12 col-sm-12 col col-md-6 col-lg-4">
	<div class="panel panel-info">
		...
		<div class="panel-body">
			...
			<center><img class="cuadradoFoto" src="global/images/AlimentoNoDisponible.png" width="100px" height="100px"/></center>
			@else
			@if(File::exists($value->Alimento->ruta_imagen_alimento))
			<center><img class="cuadradoFoto FotoGrande" src="{{$value->Alimento->ruta_imagen_alimento}}" Imagen="{{$value->Alimento->ruta_imagen_alimento}}" width="100px" height="100px"/></center>	
			@else		
							...
							<tr>
								...
								<td>								
									<span class="badge btn-md btn-success">
										<b><strong> <font size ="2">{{$value->cantidad_alimento_venta}}</font></strong>
										</b></span>								
									</td>
								</tr>
								<tr>
