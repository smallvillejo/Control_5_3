					...
					<table class="table table-striped table-bordered table-hover">
						...
						<tbody>
							...
							<tr class="even pointer">
								...
								<td class=" "><b><strong> <font size ="2", color="#000000" face="Arial Black">{{Carbon::parse($value->hora_venta_alimento)->diffForHumans()}} <!-- (A las: {{Carbon::parse($value->hora_venta_alimento)->toTimeString()}}) -->
								</font></strong></b></td>
								<td class=" ">
