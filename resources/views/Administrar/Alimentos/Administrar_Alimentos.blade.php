	...
	<div class="page-bar col-xs-12 col-sm-12 col-md-12 col-lg-12">
		<ul class="page-breadcrumb">
			...
			<li>
				...
				<a href="{{URL::route('AdministrarAlimentos')}}">Administrar Alimentos</a>
				<i class="fa fa-angle-right"></i>
			</li>
			<li>
			...
			<li class="dropdown" id="reportes" class="reportes">
				...
				<a class="dropdown-toggle" data-toggle="dropdown" href="#">Reportes - Listado de Alimentos
					...
					<ul class="dropdown-menu">
						<li>							
							<a href="{{URL::route('Exportar_Excel_Total_Alimentos')}}" title="Exportar Excel" id="btn_reporte_excel_alimento"><i class="fa fa-file-excel-o" aria-hidden="true"></i>EXCEL</a>	
						</li>
						<li>
							<a href="{{URL::route('Exportar_PDF_Total_Alimentos')}}" title="Exportar PDF" id="btn_reporte_pdf_alimento"><i class="fa fa-file-pdf-o" aria-hidden="true"></i>PDF</a>	
						</li>						
					</ul>
				</li>	
			</ul>
				...
				<div class="alert alert-danger" style="display: none;" id="success-alerta2">					
					...
					<script type="text/javascript">
						...
						function Listar_Alimentos(){
							$.ajax({
								type:'get',
								url:'{{ url('Cargar_Alimentos_En_Administrar')}}',
								...
								<div class="modal-body">
									<form class="form-horizontal" enctype="multipart/form-data" id="upload_form" role="form" method="POST" action="" >
										...
										<div class="form-group">
											...
											<div class="col-sm-9">
												<input type="number" id="valor_inversion_alimento" name="valor_inversion_alimento" placeholder="Valor Inversión Alimento" class="form-control">      
											</div>
										</div>
										...
										<div class="form-group">    
											...
											<div class="col-sm-9">   
												<input type="file" name="imagenAlimento" class="form-control btn btn-primary" id="catagry_logo" accept="image/jpeg, image/jpg,image/png" />
...
<script type="text/javascript">	
	$('body').delegate('.Edit_Aliment','click',function(){			
		...
		$.ajax({
			type:'POST',
			url:'{{ url('Consultar_Alimento_Modificar')}}',
			async : false,
			data:{
			...
			<div class="modal-body">
				...
				<form class="form-horizontal" enctype="multipart/form-data" id="Formulario_Editar_Alimento" role="form" method="POST" action="" >
					...
					<div class="form-group">    
						<label class="col-sm-3 control-label">Imagen Alimento:</label>  
						<div class="col-sm-9">   
							<input type="file" name="imagenAlimento_editar" class="form-control btn btn-primary" id="catagry_logo_editar" accept="image/jpeg, image/jpg ,image/png" />
							<span class="help-block">Solo se permiten formatos: JPG,JPEG y PNG.</span>        
						</div>
					</div>
