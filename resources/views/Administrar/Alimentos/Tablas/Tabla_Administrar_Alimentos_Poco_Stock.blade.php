		...
		<div class="panel-body">
			...
			<div class="panel-footer">Última actualización: {{Carbon::parse($value->Fecha_Creacion)->toDateString()}}
				<div class="btn-group pull-right">				
					...
					<a href="#" data-toggle = 'modal' data-target="#Modal_Confirmacion_Delete" title="Eliminar" class="Delete_Aliment" NombreAlimento="{{$nombre_alimento = strtoupper($nombre_alimento)}}"  Id_alimentoEliminar="{{$value->id}}" <strong> <font size ="3", color="#0eacf9" face="Lucida Sans"><span class= "fa fa-trash-o fa-2x"></span></font></a>					
				</div>
			</div>
		</div>
	</div>
