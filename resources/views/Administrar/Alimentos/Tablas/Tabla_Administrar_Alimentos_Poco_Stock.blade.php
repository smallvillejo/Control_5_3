@if($Alimentos->total()==0)
<div class="col-md-12">
	<img src="global/images/sin_alimento_registrado_Stock.png" alt="logo" class="img-thumbnail img-responsive" >
...
<input type="hidden" value="{{$valor_venta_alimento=number_format($value->valor_venta_alimento)}}">
...
<div class="col-xs-12 col-sm-12 col col-md-6 col-lg-4">
	<div class="panel panel-info">
		...
		<div class="panel-body">
			@if($value->ruta_imagen_alimento==null)
			<center><img class="cuadradoFoto" src="global/images/AlimentoNoDisponible.png" width="200px" height="200px"/></center>
			@else
			@if(File::exists($value->ruta_imagen_alimento))
			<center><img class="cuadradoFoto FotoGrande" src="{{$value->ruta_imagen_alimento}}" Imagen="{{$value->ruta_imagen_alimento}}" width="200px" height="200px"/></center>	
			@else		
			<center><img class="cuadradoFoto" src="global/images/AlimentoNoDisponible.png" width="200px" height="200px"/></center>
			@endif
			@endif
					...
					<div class="row">
						<tbody>
							<tr>
								...
								<td>
									@if($value->cantidad_alimento==0)
									<span class="badge btn-md btn-danger" title="0 Stock--Debe surtir este alimento."><b><strong> <font size ="2">0 Stock.
									</font></strong></b></span>
									@else
									@if($value->cantidad_alimento<=3)
									<span class="badge btn-md btn-warning" title="Poco Stock"><b><strong> <font size ="2">{{$value->cantidad_alimento}}
									</font></strong></b></span>   
									@else
									<span class="badge btn-md btn-success"><b><strong> <font size ="2">{{$value->cantidad_alimento}}
									</font></strong></b></span>					
									@endif
									@endif
								</td>
							...
							<tr>
								...
								<td>
									<span class="badge btn-md btn-success"><b><strong> <font size ="2">${{$valor_venta_alimento}}</font></strong></b></span>
								</td>								
							</tr>
							<tr>
								<td>
								...
								<td>
									<span class="badge btn-md btn-success"><b><strong> <font size ="2">${{$valor_inversion_alimento}}
									</font></strong></b></span>
			...
			<div class="panel-footer">Última actualización: {{Carbon::parse($value->Fecha_Creacion)->toDateString()}}
				<div class="btn-group pull-right">				
					<a href="#" data-toggle = 'modal' data-target="#Modal_Modificar_Alimentos" title="Modificar" class="Edit_Aliment" Id_alimentoEditar="{{$value->id}}" <strong> <font size ="3", color="#0eacf9" face="Lucida Sans"><span class= "fa fa-pencil-square fa-2x"></span></font></a>

					<a href="#" data-toggle = 'modal' data-target="#Modal_Confirmacion_Delete" title="Eliminar" class="Delete_Product" NombreAlimento="{{$nombre_alimento = strtoupper($nombre_alimento)}}"  Id_alimentoEliminar="{{$value->id}}" <strong> <font size ="3", color="#0eacf9" face="Lucida Sans"><span class= "fa fa-trash-o fa-2x"></span></font></a>					
				</div>
			</div>
		</div>
	</div>
