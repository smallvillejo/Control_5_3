        ...
        <table>
          ...
          <tbody class="body">
            ...
            <tr>
              ...
              <td class="desc"><b><strong><font size ="5", face="Arial Black">{{$value->nombre_alimento}}</font></strong></b></td>
              <td class="qty">{{$value->cantidad_alimento}} </td>
              <td class="qty">${{$Valor_Venta=number_format($value->valor_venta_alimento)}}</td>
              <td class="qty">${{$Valor_Inversion_Total=number_format($value->valor_inversion_alimento)}} </td>
