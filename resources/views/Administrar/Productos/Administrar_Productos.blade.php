			...
			<li class="dropdown" id="reportes" class="reportes">
				...
				<a class="dropdown-toggle" data-toggle="dropdown" href="#">Reportes - Listado de Productos
					...
					<ul class="dropdown-menu">
						<li>							
							<a href="{{URL::route('exportar_report_excel')}}" title="Exportar Excel" id="btn_reporte_excel_producto"><i class="fa fa-file-excel-o" aria-hidden="true"></i>EXCEL</a>	
						</li>
						<li>
							<a href="{{URL::route('exportar_report_pdf')}}" title="Exportar PDF" id="btn_reporte_pdf_producto"><i class="fa fa-file-pdf-o" aria-hidden="true"></i>PDF</a>	
						</li>						
					</ul>
				</li>	
			</ul>
