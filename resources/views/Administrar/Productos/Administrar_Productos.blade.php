	...
	<div class="page-bar col-xs-12 col-sm-12 col-md-12 col-lg-12">
		<ul class="page-breadcrumb">
			...
			<li>
				...
				<a href="{{URL::route('AdministrarProductos')}}">Administrar Productos</a>
				<i class="fa fa-angle-right"></i>
			</li>
			<li>
			...
			<li class="dropdown" id="reportes" class="reportes">
				...
				<a class="dropdown-toggle" data-toggle="dropdown" href="#">Reportes - Listado de Productos
					...
					<ul class="dropdown-menu">
						<li>							
							<a href="{{URL::route('Exportar_Excel_Total_Productos')}}" title="Exportar Excel" id="btn_reporte_excel_producto"><i class="fa fa-file-excel-o" aria-hidden="true"></i>EXCEL</a>	
						</li>
						<li>
							<a href="{{URL::route('Exportar_PDF_Total_Productos')}}" title="Exportar PDF" id="btn_reporte_pdf_producto"><i class="fa fa-file-pdf-o" aria-hidden="true"></i>PDF</a>	
						</li>						
					</ul>
				</li>	
			</ul>
		...
		<div class="panel panel-default" id="Panel_Tabla_Administrar_Productos" style="display: none">
			<div class="panel-heading"><center><i class="fa fa-cube fa-2x">Listado de Productos</center></i>
			</div>
				...
				<div class="alert alert-danger" style="display: none;" id="success-alerta2">					
					...
					<script type="text/javascript">
						...
						function Listar_Productos(){
							$.ajax({
								type:'get',
								url:'{{ url('Cargar_Productos_En_Administrar')}}',
...
<script type="text/javascript">	
	$('body').delegate('.Edit_Product','click',function(){			
		...
		$.ajax({
			type:'POST',
			url:'{{ url('Consultar_Producto_Modificar')}}',
			async : false,
			data:{
			...
			<div class="modal-body">
				...
				<form class="form-horizontal" enctype="multipart/form-data" id="Formulario_Editar_Producto" role="form" method="POST" action="" >
					...
					<div class="form-group">    
						<label class="col-sm-3 control-label">Imagen Producto:</label>  
						<div class="col-sm-9">   
							<input type="file" name="imagenProducto_editar" class="form-control btn btn-primary" id="catagry_logo_editar" accept="image/jpeg, image/jpg,image/png" />
							<span class="help-block">Solo se permiten formatos: JPG,JPEG y PNG.</span>        
						</div>
					</div>
