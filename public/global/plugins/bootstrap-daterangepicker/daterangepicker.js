                ...
                '<div class="ranges">' +
                  '<div class="range_inputs">' +
                    '<div class="daterangepicker_start_input">' +
                      ...
                      '<input class="input-mini" type="text" name="daterangepicker_start" id="daterangepicker_start" value="" readonly/>' +
                    '</div>' +
                    '<div class="daterangepicker_end_input">' +
                      '<label for="daterangepicker_end"></label>' +
                      '<input class="input-mini" type="text" name="daterangepicker_end" id="daterangepicker_end" value="" readonly/>' +
                    '</div>' +
                    '<button class="applyBtn" onclick="BuscarRango();" disabled="disabled"></button>&nbsp;' +                    
                  '</div>' +
                '</div>' +
              '</div>';
